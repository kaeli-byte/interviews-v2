...
The backend WebSocket bridge is now legacy reference code. The active Next/React assistant uses the direct ephemeral-token Live connection, which keeps audio out of the backend loop.
